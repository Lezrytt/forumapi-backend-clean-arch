...
DomainErrorTranslator._directories = {
  ...
  'ADD_COMMENT.NOT_CONTAIN_NEEDED_PROPERTY_TID': new InvariantError('tidak dapat membuat comment baru karena properti yang dibutuhkan tidak ada (TID)'),
  'ADD_COMMENT.NOT_CONTAIN_NEEDED_PROPERTY_UID': new InvariantError('tidak dapat membuat comment baru karena properti yang dibutuhkan tidak ada (UID)'),
